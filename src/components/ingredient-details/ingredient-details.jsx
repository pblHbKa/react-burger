...
const IngredientDetails = (props) => {
    ...
    return ( props.data &&
        <div className={ingredientsDetailsStyles.ingredientsDetails}>
            <img className={ingredientsDetailsStyles.image} src={props.data.image} alt={props.data.name}/>
            <p className="text text_type_main-medium mt-4 mb-8">{props.data.name}</p>
            <div className={`${ingredientsDetailsStyles.nutrients} mb-15 text text_type_main-default text_color_inactive`}>
